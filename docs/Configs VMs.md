...
- **Windows Server (AD + DNS + DHCP)**  
![Win Server Net](prints/windows-server-net.png)

- **Windows Client**  
![Win Client Net](prints/windows-client-net.png)

- **Ubuntu Server (Wazuh)**  
![Ubuntu Wazuh Net](prints/ubuntu-wazuh-net.png)

- **Ubuntu Server (Suricata + Grafana)**  
![Ubuntu Suricata Grafana Net](prints/ubuntu-suricata-grafana-net.png)

- **Kali Linux**  
![Kali Net](prints/kali-net.png)

---

📌 **Obs:** Todos os prints devem ser salvos dentro da pasta `docs/prints/` para manter a organização.  
